#!/bin/bash
# amp-rbc-md Setup Script - FIXED VERSION
# Behebt alle Abhängigkeitskonflikte und erstellt eine saubere Installation
# PyTorch 2.3.0+cu121 + JAX 0.4.25 + ColabFold 1.5.5 + gmxapi

set -e

echo "=== AMP-RBC-MD SETUP - FIXED VERSION ==="
...
# Installiere Basis-Pakete mit kompatiblen Versionen
...
# Installiere gmxapi über conda (bessere Kompatibilität)
echo "Installiere gmxapi über conda..."
conda install -c conda-forge gmxapi -y || echo "⚠️  gmxapi über conda nicht verfügbar"

# Installiere JAX 0.4.25 mit CUDA (VOR ColabFold)
...
# Installiere ColabFold-Abhängigkeiten mit kompatiblen Versionen
...
echo "Installiere ColabFold ohne Abhängigkeiten..."
